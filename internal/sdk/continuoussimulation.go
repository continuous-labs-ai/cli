...
// Generated from OpenAPI doc version v1 and generator version 2.935.1
...
type SDKOption func(*ContinuousSimulation)

// WithServerURL allows providing an alternative server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *ContinuousSimulation) {
...
func New(opts ...SDKOption) *ContinuousSimulation {
	sdk := &ContinuousSimulation{
		SDKVersion: "0.1.14",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:         "speakeasy-sdk/go 0.1.14 2.935.1 v1 github.com/continuous-labs-ai/cli/internal/sdk",
			SDKVersion:        "0.1.14",
			GenVersion:        "2.935.1",
