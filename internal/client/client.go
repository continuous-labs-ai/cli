...
func NewClient(cmd *cobra.Command) (*sdk.ContinuousSimulation, error) {
...
func buildGlobalSecurity(cmd *cobra.Command) components.Security {
	...
	apiKeyAuth, _ := config.ResolveSecurityCredential(cmd, "api-key-auth")
	globalSecurity := components.Security{}
	if apiKeyAuth != "" {
		globalSecurity.APIKeyAuth = apiKeyAuth
	}
