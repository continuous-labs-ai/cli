...
import (
	"fmt"
	"github.com/continuous-labs-ai/continuous-simulation-cli/internal/cli/simulations"
	"github.com/continuous-labs-ai/continuous-simulation-cli/internal/cli/simulators"
	"github.com/continuous-labs-ai/continuous-simulation-cli/internal/cli/worlds"
	"github.com/continuous-labs-ai/continuous-simulation-cli/internal/config"
	"github.com/continuous-labs-ai/continuous-simulation-cli/internal/explorer"
...
func NewRootCommand() (*cobra.Command, error) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
			...
			if err := config.Init("continuous", "CONTINUOUS"); err != nil {
				return err
			}
	...
	if err := simulators.InitSimulatorsRoot(rootCmd); err != nil {
		return nil, fmt.Errorf("init simulators: %w", err)
	}
	if err := worlds.InitWorldsRoot(rootCmd); err != nil {
		return nil, fmt.Errorf("init worlds: %w", err)
	}
	...
	rootCmd.PersistentFlags().String("api-key-auth", "", "Use a Continuous API key. Send it in the Authorization header as a Bearer token.")
