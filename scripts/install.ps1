...
#
# Usage:
#   iwr -useb https://raw.githubusercontent.com/continuous-labs-ai/continuous-simulation-cli/main/scripts/install.ps1 | iex
#   or
#   Invoke-WebRequest -Uri https://raw.githubusercontent.com/continuous-labs-ai/continuous-simulation-cli/main/scripts/install.ps1 -UseBasicParsing | Invoke-Expression
#
# Options:
...
# Configuration
$Repo = "continuous-labs-ai/continuous-simulation-cli"
